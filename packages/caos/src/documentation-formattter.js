import { getValueTypeName, getValuesList, } from "@creatureslsp/caos-kt/caos-libs";
function wrapParameter(parameter) {
    if (parameter == null) {
        return "(value)";
    }
...
function formatParameter(parameter, withValuesList) {
...
export function formatCaosDocumentation(variant, command, withValuesLists = false) {
    if (command == null)
        return null;
    let out = "";
...
export function formatCommandStringAsMarkdown(command, string) {
