import { Caos2CobFormats } from "./caos2cob.formats.js";
import { Caos2ValueType } from "./caos2-util.js";
export const CAOS2COB_TAGS = [
    {
...
export function findCobTag(tag) {
    tag = tag.toLowerCase();
    const found = tagFinder.find(([regexp]) => regexp.test(tag));
