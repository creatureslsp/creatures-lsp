...
class Companion {
  constructor() {
    ...
    tmp.z20_1 = [null, null, tmp_1, null, null, tmp_3, null, lazy(tmp_4, CaosCommand$Companion$$childSerializers$_anonymous__psokld_1), null, null, null, null, null, null, null];
  }
}
class $serializer {
  constructor() {
    ...
    this.a21_1 = tmp0_serialDesc;
  }
  b21(encoder, value) {
    var tmp0_desc = this.a21_1;
    var tmp1_output = encoder.bw(tmp0_desc);
    var tmp2_cached = Companion_getInstance().z20_1;
    tmp1_output.mx(tmp0_desc, 0, value.c21_1);
    tmp1_output.rx(tmp0_desc, 1, value.d21_1);
    tmp1_output.tx(tmp0_desc, 2, tmp2_cached[2].k3(), value.e21_1);
    tmp1_output.mx(tmp0_desc, 3, value.f21_1);
    if (tmp1_output.zx(tmp0_desc, 4) ? true : !(value.g21_1 == null)) {
      tmp1_output.vx(tmp0_desc, 4, StringSerializer_getInstance(), value.g21_1);
    }
    if (tmp1_output.zx(tmp0_desc, 5) ? true : !(value.h21_1 == null)) {
      tmp1_output.vx(tmp0_desc, 5, tmp2_cached[5].k3(), value.h21_1);
    }
    if (tmp1_output.zx(tmp0_desc, 6) ? true : !(value.i21_1 === 0)) {
      tmp1_output.mx(tmp0_desc, 6, value.i21_1);
    }
    tmp1_output.tx(tmp0_desc, 7, tmp2_cached[7].k3(), value.j21_1);
    tmp1_output.jx(tmp0_desc, 8, value.k21_1);
    tmp1_output.jx(tmp0_desc, 9, value.l21_1);
    if (tmp1_output.zx(tmp0_desc, 10) ? true : !(value.m21_1 == null)) {
      tmp1_output.vx(tmp0_desc, 10, StringSerializer_getInstance(), value.m21_1);
    }
    tmp1_output.rx(tmp0_desc, 11, value.n21_1);
    if (tmp1_output.zx(tmp0_desc, 12) ? true : !(value.o21_1 == null)) {
      tmp1_output.vx(tmp0_desc, 12, StringSerializer_getInstance(), value.o21_1);
    }
    if (tmp1_output.zx(tmp0_desc, 13) ? true : !(value.p21_1 === false)) {
      tmp1_output.jx(tmp0_desc, 13, value.p21_1);
    }
    if (tmp1_output.zx(tmp0_desc, 14) ? true : !(value.q21_1 == null)) {
      tmp1_output.vx(tmp0_desc, 14, BooleanSerializer_getInstance(), value.q21_1);
    }
    tmp1_output.cw(tmp0_desc);
  }
  mr(encoder, value) {
    return this.b21(encoder, value instanceof CaosCommand ? value : THROW_CCE());
  }
  nr(decoder) {
    var tmp0_desc = this.a21_1;
    var tmp1_flag = true;
    ...
    var tmp23_cached = Companion_getInstance().z20_1;
    if (tmp22_input.sw()) {
    ...
    return CaosCommand.u21(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, tmp7_local3, tmp8_local4, tmp9_local5, tmp10_local6, tmp11_local7, tmp12_local8, tmp13_local9, tmp14_local10, tmp15_local11, tmp16_local12, tmp17_local13, tmp18_local14, null);
  }
  lr() {
    return this.a21_1;
  }
  l14() {
    var tmp0_cached = Companion_getInstance().z20_1;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
...
class CaosCommand {
  constructor(id, command, parameters, returnTypeId, description, returnValuesListIds, requiresOwnr, variants, rvalue, lvalue, lvalueName, commandGroup, doifFormat, requiresCreatureOwnr, ceOnly) {
    ...
    this.c21_1 = id;
    this.d21_1 = command;
    this.e21_1 = parameters;
    this.f21_1 = returnTypeId;
    this.g21_1 = description;
    this.h21_1 = returnValuesListIds;
    this.i21_1 = requiresOwnr;
    this.j21_1 = variants;
    this.k21_1 = rvalue;
    this.l21_1 = lvalue;
    this.m21_1 = lvalueName;
    this.n21_1 = commandGroup;
    this.o21_1 = doifFormat;
    this.p21_1 = requiresCreatureOwnr;
    this.q21_1 = ceOnly;
    var tmp = this;
    tmp.r21_1 = lazy_0(CaosCommand$tokens$delegate$lambda(this));
    var tmp_0 = this;
    tmp_0.s21_1 = lazy_0(CaosCommand$fullCommandHeader$delegate$lambda(this));
    var tmp_1 = this;
    tmp_1.t21_1 = lazy_0(CaosCommand$isCommand$delegate$lambda(this));
  }
  v21() {
    return Companion_instance.fromIntValue(this.f21_1);
  }
  p1s() {
    var tmp0 = this.r21_1;
    var tmp = KProperty1;
  ...
  equals(other) {
    ...
    if (!(this.d21_1 === other.d21_1))
      return false;
    if (!contentEquals(this.e21_1, other.e21_1))
      return false;
    if (!this.v21().equals(other.v21()))
      return false;
    ...
    if (!(this.i21_1 === other.i21_1))
      return false;
    if (!contentEquals(this.j21_1, other.j21_1))
      return false;
    if (!(this.k21_1 === other.k21_1))
      return false;
    if (!(this.l21_1 === other.l21_1))
      return false;
    if (!(this.m21_1 == other.m21_1))
      return false;
  ...
  hashCode() {
    var result = this.c21_1;
    result = imul(31, result) + getStringHashCode(this.d21_1) | 0;
    result = imul(31, result) + contentHashCode(this.e21_1) | 0;
    result = imul(31, result) + this.v21().hashCode() | 0;
    var tmp = imul(31, result);
    var tmp0_safe_receiver = this.g21_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    result = tmp + (tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs) | 0;
    var tmp_0 = imul(31, result);
    var tmp2_safe_receiver = this.h21_1;
    var tmp3_elvis_lhs = tmp2_safe_receiver == null ? null : hashCode(tmp2_safe_receiver);
    result = tmp_0 + (tmp3_elvis_lhs == null ? 0 : tmp3_elvis_lhs) | 0;
    result = imul(31, result) + this.i21_1 | 0;
    result = imul(31, result) + contentHashCode(this.j21_1) | 0;
    result = imul(31, result) + getBooleanHashCode(this.k21_1) | 0;
    result = imul(31, result) + getBooleanHashCode(this.l21_1) | 0;
    ...
    result = imul(31, result) + getStringHashCode(this.n21_1) | 0;
    ...
    result = imul(31, result) + getBooleanHashCode(this.p21_1) | 0;
    return result;
  }
  y21(id, command, parameters, returnTypeId, description, returnValuesListIds, requiresOwnr, variants, rvalue, lvalue, lvalueName, commandGroup, doifFormat, requiresCreatureOwnr, ceOnly) {
  ...
  z21(id, command, parameters, returnTypeId, description, returnValuesListIds, requiresOwnr, variants, rvalue, lvalue, lvalueName, commandGroup, doifFormat, requiresCreatureOwnr, ceOnly, $super) {
    id = id === VOID ? this.c21_1 : id;
    command = command === VOID ? this.d21_1 : command;
    parameters = parameters === VOID ? this.e21_1 : parameters;
    returnTypeId = returnTypeId === VOID ? this.f21_1 : returnTypeId;
    description = description === VOID ? this.g21_1 : description;
    returnValuesListIds = returnValuesListIds === VOID ? this.h21_1 : returnValuesListIds;
    requiresOwnr = requiresOwnr === VOID ? this.i21_1 : requiresOwnr;
    variants = variants === VOID ? this.j21_1 : variants;
    rvalue = rvalue === VOID ? this.k21_1 : rvalue;
    lvalue = lvalue === VOID ? this.l21_1 : lvalue;
    lvalueName = lvalueName === VOID ? this.m21_1 : lvalueName;
    commandGroup = commandGroup === VOID ? this.n21_1 : commandGroup;
    doifFormat = doifFormat === VOID ? this.o21_1 : doifFormat;
    requiresCreatureOwnr = requiresCreatureOwnr === VOID ? this.p21_1 : requiresCreatureOwnr;
    ceOnly = ceOnly === VOID ? this.q21_1 : ceOnly;
    return $super === VOID ? this.y21(id, command, parameters, returnTypeId, description, returnValuesListIds, requiresOwnr, variants, rvalue, lvalue, lvalueName, commandGroup, doifFormat, requiresCreatureOwnr, ceOnly) : $super.y21.call(this, id, command, parameters, returnTypeId, description, returnValuesListIds, requiresOwnr, variants, rvalue, lvalue, lvalueName, commandGroup, doifFormat, requiresCreatureOwnr, ceOnly);
  }
  toString() {
    return 'CaosCommand(id=' + this.c21_1 + ', command=' + this.d21_1 + ', parameters=' + toString(this.e21_1) + ', returnTypeId=' + this.f21_1 + ', description=' + this.g21_1 + ', returnValuesListIds=' + toString_0(this.h21_1) + ', requiresOwnr=' + this.i21_1 + ', variants=' + toString(this.j21_1) + ', rvalue=' + this.k21_1 + ', lvalue=' + this.l21_1 + ', lvalueName=' + this.m21_1 + ', commandGroup=' + this.n21_1 + ', doifFormat=' + this.o21_1 + ', requiresCreatureOwnr=' + this.p21_1 + ', ceOnly=' + this.q21_1 + ')';
  }
  static u21(seen0, id, command, parameters, returnTypeId, description, returnValuesListIds, requiresOwnr, variants, rvalue, lvalue, lvalueName, commandGroup, doifFormat, requiresCreatureOwnr, ceOnly, serializationConstructorMarker) {
    Companion_getInstance();
    if (!(2959 === (2959 & seen0))) {
      throwMissingFieldException(seen0, 2959, $serializer_getInstance().a21_1);
    }
    ...
    if (0 === (seen0 & 16384))
      ...
      $this.q21_1 = ceOnly;
    var tmp = $this;
    tmp.r21_1 = lazy_0(CaosCommand$_init_$lambda_fg2qzm($this));
    var tmp_0 = $this;
    tmp_0.s21_1 = lazy_0(CaosCommand$_init_$lambda_fg2qzm_0($this));
    var tmp_1 = $this;
    tmp_1.t21_1 = lazy_0(CaosCommand$_init_$lambda_fg2qzm_1($this));
    return $this;
  }
}
class Companion_0 {
  constructor() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.a22_1 = [null, tmp_1, tmp_3, lazy(tmp_4, CaosLibDefinitions$Companion$$childSerializers$_anonymous__fp73zn_1)];
  }
  k1e() {
...
class $serializer_0 {
  ...
  c22(encoder, value) {
    ...
    var tmp1_output = encoder.bw(tmp0_desc);
    var tmp2_cached = Companion_getInstance_0().a22_1;
    tmp1_output.nx(tmp0_desc, 0, value.d22_1);
    tmp1_output.tx(tmp0_desc, 1, tmp2_cached[1].k3(), value.e22_1);
    tmp1_output.tx(tmp0_desc, 2, tmp2_cached[2].k3(), value.f22_1);
    tmp1_output.tx(tmp0_desc, 3, tmp2_cached[3].k3(), value.g22_1);
    tmp1_output.cw(tmp0_desc);
  }
  mr(encoder, value) {
    return this.c22(encoder, value instanceof CaosLibDefinitions ? value : THROW_CCE());
  }
  nr(decoder) {
    var tmp0_desc = this.b22_1;
    var tmp1_flag = true;
    ...
    var tmp10_cached = Companion_getInstance_0().a22_1;
    if (tmp9_input.sw()) {
    ...
    return CaosLibDefinitions.i22(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, tmp7_local3, null);
  }
  lr() {
    return this.b22_1;
  }
  l14() {
    var tmp0_cached = Companion_getInstance_0().a22_1;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
...
class CaosLibDefinitions {
  constructor(modDate, commands, variantMap, valuesLists) {
    ...
    this.d22_1 = modDate;
    this.e22_1 = commands;
    this.f22_1 = variantMap;
    this.g22_1 = valuesLists;
    var tmp = this;
    tmp.h22_1 = lazy_0(CaosLibDefinitions$commandsById$delegate$lambda(this));
  }
  j22() {
    var tmp0 = this.h22_1;
    var tmp = KProperty1;
  ...
  k22(modDate, commands, variantMap, valuesLists) {
    return new CaosLibDefinitions(modDate, commands, variantMap, valuesLists);
  }
  l22(modDate, commands, variantMap, valuesLists, $super) {
    modDate = modDate === VOID ? this.d22_1 : modDate;
    commands = commands === VOID ? this.e22_1 : commands;
    variantMap = variantMap === VOID ? this.f22_1 : variantMap;
    valuesLists = valuesLists === VOID ? this.g22_1 : valuesLists;
    return $super === VOID ? this.k22(modDate, commands, variantMap, valuesLists) : $super.k22.call(this, modDate, commands, variantMap, valuesLists);
  }
  toString() {
    return 'CaosLibDefinitions(modDate=' + this.d22_1.toString() + ', commands=' + toString(this.e22_1) + ', variantMap=' + toString(this.f22_1) + ', valuesLists=' + toString(this.g22_1) + ')';
  }
  hashCode() {
    var result = getBigIntHashCode(this.d22_1);
  ...
  equals(other) {
    ...
    if (!(other instanceof CaosLibDefinitions))
      return false;
    if (!(this.d22_1 === other.d22_1))
      return false;
    if (!equals(this.e22_1, other.e22_1))
      return false;
    if (!equals(this.f22_1, other.f22_1))
      return false;
    if (!equals(this.g22_1, other.g22_1))
      return false;
    return true;
  }
  static i22(seen0, modDate, commands, variantMap, valuesLists, serializationConstructorMarker) {
    Companion_getInstance_0();
    if (!(15 === (15 & seen0))) {
      throwMissingFieldException(seen0, 15, $serializer_getInstance_0().b22_1);
    }
    var $this = createThis(this);
    $this.d22_1 = modDate;
    $this.e22_1 = commands;
    ...
    $this.g22_1 = valuesLists;
    var tmp = $this;
    tmp.h22_1 = lazy_0(CaosLibDefinitions$_init_$lambda_tfojde($this));
    return $this;
  }
}
class Companion_1 {
  constructor() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.m22_1 = [null, null, null, lazy(tmp_0, CaosParameter$Companion$$childSerializers$_anonymous__oeh02l), null, null, null];
  }
}
class $serializer_1 {
  constructor() {
  ...
  o22(encoder, value) {
    ...
    var tmp1_output = encoder.bw(tmp0_desc);
    var tmp2_cached = Companion_getInstance_1().m22_1;
  ...
  mr(encoder, value) {
    return this.o22(encoder, value instanceof CaosParameter ? value : THROW_CCE());
  }
  nr(decoder) {
    var tmp0_desc = this.n22_1;
    var tmp1_flag = true;
    ...
    var tmp13_cached = Companion_getInstance_1().m22_1;
    if (tmp12_input.sw()) {
    ...
    return CaosParameter.p22(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, tmp7_local3, tmp8_local4, tmp9_local5, tmp10_local6, null);
  }
  lr() {
    return this.n22_1;
  }
  l14() {
    var tmp0_cached = Companion_getInstance_1().m22_1;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
...
class CaosParameter {
  constructor(index, name, typeId, valuesListIds, description, min, max) {
    ...
    this.max = max;
    var tmp = this;
    tmp.w21_1 = lazy_0(CaosParameter$type$delegate$lambda(this));
  }
  e1s() {
    return this.index;
  }
  ...
  v22(index, name, typeId, valuesListIds, description, min, max) {
    return new CaosParameter(index, name, typeId, valuesListIds, description, min, max);
  }
  w22(index, name, typeId, valuesListIds, description, min, max, $super) {
    index = index === VOID ? this.index : index;
    name = name === VOID ? this.name : name;
    typeId = typeId === VOID ? this.typeId : typeId;
    valuesListIds = valuesListIds === VOID ? this.valuesListIds : valuesListIds;
    description = description === VOID ? this.description : description;
    min = min === VOID ? this.min : min;
    max = max === VOID ? this.max : max;
    return $super === VOID ? this.v22(index, name, typeId, valuesListIds, description, min, max) : $super.v22.call(this, index, name, typeId, valuesListIds, description, min, max);
  }
  toString() {
  ...
  static p22(seen0, index, name, typeId, valuesListIds, description, min, max, serializationConstructorMarker) {
    Companion_getInstance_1();
    if (!(7 === (7 & seen0))) {
      throwMissingFieldException(seen0, 7, $serializer_getInstance_1().n22_1);
    }
    var $this = createThis(this);
    $this.index = index;
    $this.name = name;
    ...
    if (0 === (seen0 & 64))
      ...
      $this.max = max;
    var tmp = $this;
    tmp.w21_1 = lazy_0(CaosParameter$_init_$lambda_3besw4($this));
    return $this;
  }
  get type() {
    return this.d1s();
...
class Companion_2 {
  constructor() {
    ...
    var tmp = this;
    var tmp_0 = LazyThreadSafetyMode_PUBLICATION_getInstance();
    tmp.x22_1 = lazy(tmp_0, CaosScriptVarTokenGroup$Companion$_anonymous__6yzde9);
  }
  k1e() {
...
class Companion_3 {
  constructor() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.b23_1 = [null, null, tmp_1, null, null, tmp_3, lazy(tmp_4, CaosValuesList$Companion$$childSerializers$_anonymous__8fg7ag_1)];
  }
}
class $serializer_2 {
  constructor() {
    ...
    this.c23_1 = tmp0_serialDesc;
  }
  d23(encoder, value) {
    var tmp0_desc = this.c23_1;
    var tmp1_output = encoder.bw(tmp0_desc);
    var tmp2_cached = Companion_getInstance_3().b23_1;
    ...
    if (tmp1_output.zx(tmp0_desc, 5)) {
      ...
      tmp = !equals(value.e23_1, destination);
    }
    if (tmp) {
      tmp1_output.tx(tmp0_desc, 5, tmp2_cached[5].k3(), value.e23_1);
    }
    var tmp_0;
    if (tmp1_output.zx(tmp0_desc, 6)) {
      ...
      tmp_0 = !equals(value.f23_1, destination_0);
    }
    if (tmp_0) {
      tmp1_output.tx(tmp0_desc, 6, tmp2_cached[6].k3(), value.f23_1);
    }
    tmp1_output.cw(tmp0_desc);
  }
  mr(encoder, value) {
    return this.d23(encoder, value instanceof CaosValuesList ? value : THROW_CCE());
  }
  nr(decoder) {
    var tmp0_desc = this.c23_1;
    var tmp1_flag = true;
    ...
    var tmp10_local6 = null;
    var tmp12_input = decoder.bw(tmp0_desc);
    var tmp13_cached = Companion_getInstance_3().b23_1;
    if (tmp12_input.sw()) {
      tmp4_local0 = tmp12_input.gw(tmp0_desc, 0);
      tmp3_bitMask0 = tmp3_bitMask0 | 1;
      tmp5_local1 = tmp12_input.lw(tmp0_desc, 1);
    ...
    tmp12_input.cw(tmp0_desc);
    return CaosValuesList.m23(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, tmp7_local3, tmp8_local4, tmp9_local5, tmp10_local6, null);
  }
  lr() {
    return this.c23_1;
  }
  l14() {
    var tmp0_cached = Companion_getInstance_3().b23_1;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
...
class CaosValuesList {
  constructor(id, name, values, description, extensionType) {
    ...
    tmp_0.f23_1 = destination_0;
    var tmp_1 = this;
    tmp_1.g23_1 = lazy_0(CaosValuesList$bitflag$delegate$lambda(this));
  }
  o23() {
    return this.id;
  }
    ...
    if (tmp1_elvis_lhs == null) {
      ...
      $l$block_1: {
        ...
        while (_iterator__ex2g4s_0.x()) {
          ...
          if (ensureNotNull(element_1.n1s()) < key) {
            tmp$ret$4 = element_1;
            break $l$block_1;
          }
        }
  ...
  equals(other) {
    ...
    if (!(this.extensionType == other.extensionType))
      return false;
    if (!equals(this.e23_1, other.e23_1))
      return false;
  ...
  hashCode() {
    var result = this.id;
    result = imul(31, result) + getBooleanHashCode(this.n23()) | 0;
    ...
    result = tmp_0 + (tmp3_elvis_lhs == null ? 0 : tmp3_elvis_lhs) | 0;
    result = imul(31, result) + hashCode(this.e23_1) | 0;
  ...
  static m23(seen0, id, name, values, description, extensionType, negative, greaterThan, serializationConstructorMarker) {
    Companion_getInstance_3();
    if (!(7 === (7 & seen0))) {
      throwMissingFieldException(seen0, 7, $serializer_getInstance_2().c23_1);
    }
    var $this = createThis(this);
    $this.id = id;
    $this.name = name;
    ...
    if (0 === (seen0 & 64)) {
      ...
      $this.f23_1 = greaterThan;
    var tmp_1 = $this;
    tmp_1.g23_1 = lazy_0(CaosValuesList$_init_$lambda_11sxhl($this));
    return $this;
  }
}
class Companion_4 {}
class $serializer_3 {
  ...
  mr(encoder, value) {
    return this.r23(encoder, value instanceof ValuesListValue ? value : THROW_CCE());
  }
  nr(decoder) {
    var tmp0_desc = this.q23_1;
    var tmp1_flag = true;
    ...
    return ValuesListValue.s23(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, tmp7_local3, null);
  }
  lr() {
    return this.q23_1;
  }
...
class ValuesListValue {
  constructor(value, name, description, beforeRegion) {
    ...
    var tmp = this;
    tmp.h23_1 = lazy_0(CaosValuesListValue$intValue$delegate$lambda(this));
    var tmp_0 = this;
    tmp_0.i23_1 = lazy_0(CaosValuesListValue$not$delegate$lambda(this));
    var tmp_1 = this;
    tmp_1.j23_1 = lazy_0(CaosValuesListValue$greaterThan$delegate$lambda(this));
  }
  k3() {
    return this.value;
  }
  ...
  static s23(seen0, value, name, description, beforeRegion, serializationConstructorMarker) {
    if (!(3 === (3 & seen0))) {
      throwMissingFieldException(seen0, 3, $serializer_getInstance_3().q23_1);
    }
    var $this = createThis(this);
    $this.value = value;
    $this.name = name;
    ...
    if (0 === (seen0 & 8))
      ...
      $this.beforeRegion = beforeRegion;
    var tmp = $this;
    tmp.h23_1 = lazy_0(CaosValuesListValue$_init_$lambda_7cqd18($this));
    var tmp_0 = $this;
    tmp_0.i23_1 = lazy_0(CaosValuesListValue$_init_$lambda_7cqd18_0($this));
    var tmp_1 = $this;
    tmp_1.j23_1 = lazy_0(CaosValuesListValue$_init_$lambda_7cqd18_1($this));
    return $this;
  }
  get intValue() {
    return this.n1s();
...
class $serializer_4 {
  constructor() {
    ...
    tmp0_serialDesc.e13(new ProtoNumber(5));
    this.u23_1 = tmp0_serialDesc;
  }
  v23(encoder, value) {
    var tmp0_desc = this.u23_1;
    var tmp1_output = encoder.bw(tmp0_desc);
    tmp1_output.vx(tmp0_desc, 0, IntSerializer_getInstance(), value.w23_1);
    tmp1_output.vx(tmp0_desc, 1, IntSerializer_getInstance(), value.x23_1);
    tmp1_output.vx(tmp0_desc, 2, IntSerializer_getInstance(), value.y23_1);
    tmp1_output.vx(tmp0_desc, 3, IntSerializer_getInstance(), value.z23_1);
    tmp1_output.vx(tmp0_desc, 4, IntSerializer_getInstance(), value.a24_1);
    tmp1_output.cw(tmp0_desc);
  }
  mr(encoder, value) {
    return this.v23(encoder, value instanceof CaosVarConstraints ? value : THROW_CCE());
  }
  nr(decoder) {
    var tmp0_desc = this.u23_1;
    var tmp1_flag = true;
    ...
    tmp9_input.cw(tmp0_desc);
    return CaosVarConstraints.b24(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, tmp7_local3, tmp8_local4, null);
  }
  lr() {
    return this.u23_1;
  }
...
class CaosVarConstraints {
  ...
  get(key) {
    return this.c24(key instanceof CaosScriptVarTokenGroup ? key : THROW_CCE());
  }
  toString() {
    return 'CaosVarConstraints(VARx=' + this.w23_1 + ', VAxx=' + this.x23_1 + ', OBVx=' + this.y23_1 + ', OVxx=' + this.z23_1 + ', MVxx=' + this.a24_1 + ')';
  }
  hashCode() {
    var result = this.w23_1 == null ? 0 : this.w23_1;
  ...
  static b24(seen0, VARx, VAxx, OBVx, OVxx, MVxx, serializationConstructorMarker) {
    if (!(31 === (31 & seen0))) {
      throwMissingFieldException(seen0, 31, $serializer_getInstance_4().u23_1);
    }
    var $this = createThis(this);
    $this.w23_1 = VARx;
    $this.x23_1 = VAxx;
...
class CaosVariant {
  ...
  compareTo(version) {
    return (this.e1s() - version | 0) < 0 ? -1 : (this.e1s() - version | 0) > 0 ? 1 : 0;
  }
  equals(other) {
    if (this === other)
      return true;
    if (!(other instanceof CaosVariant))
      return false;
    if (!(this.i24() === other.i24()))
      return false;
    return true;
  }
  hashCode() {
    return getStringHashCode(this.i24());
  }
  get isOld() {
    return this.j24();
  }
...
class Companion_6 {
  constructor() {
    ...
    tmp.d24_1 = ArrayList.u1();
    var tmp_0 = this;
    var tmp_1 = LazyThreadSafetyMode_PUBLICATION_getInstance();
    tmp_0.e24_1 = lazy(tmp_1, CaosVariant$Companion$_anonymous__9oo02c);
  }
  m24(variant) {
    var tmp;
    switch (variant) {
...
class Companion_7 {
  constructor() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.n24_1 = [null, null, null, tmp_1, tmp_3, tmp_5, lazy(tmp_6, CaosVariantData$Companion$$childSerializers$_anonymous__z6x1a5_2)];
  }
}
class $serializer_5 {
  constructor() {
  ...
  p24(encoder, value) {
    var tmp0_desc = this.o24_1;
    var tmp1_output = encoder.bw(tmp0_desc);
    var tmp2_cached = Companion_getInstance_7().n24_1;
    tmp1_output.rx(tmp0_desc, 0, value.q24_1);
    tmp1_output.rx(tmp0_desc, 1, value.r24_1);
    tmp1_output.tx(tmp0_desc, 2, $serializer_getInstance_4(), value.s24_1);
    tmp1_output.tx(tmp0_desc, 3, tmp2_cached[3].k3(), value.t24_1);
    tmp1_output.tx(tmp0_desc, 4, tmp2_cached[4].k3(), value.u24_1);
    tmp1_output.tx(tmp0_desc, 5, tmp2_cached[5].k3(), value.v24_1);
    var tmp;
    if (tmp1_output.zx(tmp0_desc, 6)) {
      tmp = true;
    } else {
      ...
      var tmp$ret$0 = [];
      tmp = !equals(value.w24_1, tmp$ret$0);
    }
    if (tmp) {
      tmp1_output.tx(tmp0_desc, 6, tmp2_cached[6].k3(), value.w24_1);
    }
    tmp1_output.cw(tmp0_desc);
  }
  mr(encoder, value) {
    return this.p24(encoder, value instanceof CaosVariantData ? value : THROW_CCE());
  }
  nr(decoder) {
    var tmp0_desc = this.o24_1;
    var tmp1_flag = true;
    ...
    var tmp14_cached = Companion_getInstance_7().n24_1;
    if (tmp13_input.sw()) {
    ...
    return CaosVariantData.z24(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, tmp7_local3, tmp8_local4, tmp9_local5, tmp10_local6, null);
  }
  lr() {
    return this.o24_1;
  }
  l14() {
    var tmp0_cached = Companion_getInstance_7().n24_1;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
...
class CaosVariantData {
  constructor(name, code, vars, commands, lvalues, rvalues, valuesListsIds) {
    ...
    this.u24_1 = lvalues;
    this.v24_1 = rvalues;
    this.w24_1 = valuesListsIds;
    var tmp_0 = this;
    tmp_0.x24_1 = lazy_0(CaosVariantData$isOld$delegate$lambda(this));
    var tmp_1 = this;
    tmp_1.y24_1 = lazy_0(CaosVariantData$isNew$delegate$lambda(this));
  }
  equals(other) {
    if (this === other)
      return true;
    ...
    if (!(this.r24_1 === other.r24_1))
      return false;
    if (!this.s24_1.equals(other.s24_1))
      return false;
    if (!equals(this.t24_1, other.t24_1))
      return false;
    if (!equals(this.u24_1, other.u24_1))
      return false;
    if (!equals(this.v24_1, other.v24_1))
      return false;
    if (!contentEquals(this.w24_1, other.w24_1))
      return false;
    return true;
  }
  hashCode() {
    var result = getStringHashCode(this.q24_1);
    result = imul(31, result) + getStringHashCode(this.r24_1) | 0;
    result = imul(31, result) + this.s24_1.hashCode() | 0;
    result = imul(31, result) + hashCode(this.t24_1) | 0;
    result = imul(31, result) + hashCode(this.u24_1) | 0;
    result = imul(31, result) + hashCode(this.v24_1) | 0;
    result = imul(31, result) + contentHashCode(this.w24_1) | 0;
    return result;
  }
  a25(name, code, vars, commands, lvalues, rvalues, valuesListsIds) {
    return new CaosVariantData(name, code, vars, commands, lvalues, rvalues, valuesListsIds);
  }
  b25(name, code, vars, commands, lvalues, rvalues, valuesListsIds, $super) {
    name = name === VOID ? this.q24_1 : name;
    code = code === VOID ? this.r24_1 : code;
    vars = vars === VOID ? this.s24_1 : vars;
    commands = commands === VOID ? this.t24_1 : commands;
    lvalues = lvalues === VOID ? this.u24_1 : lvalues;
    rvalues = rvalues === VOID ? this.v24_1 : rvalues;
    valuesListsIds = valuesListsIds === VOID ? this.w24_1 : valuesListsIds;
    return $super === VOID ? this.a25(name, code, vars, commands, lvalues, rvalues, valuesListsIds) : $super.a25.call(this, name, code, vars, commands, lvalues, rvalues, valuesListsIds);
  }
  toString() {
    return 'CaosVariantData(name=' + this.q24_1 + ', code=' + this.r24_1 + ', vars=' + this.s24_1.toString() + ', commands=' + toString(this.t24_1) + ', lvalues=' + toString(this.u24_1) + ', rvalues=' + toString(this.v24_1) + ', valuesListsIds=' + toString(this.w24_1) + ')';
  }
  static z24(seen0, name, code, vars, commands, lvalues, rvalues, valuesListsIds, serializationConstructorMarker) {
    Companion_getInstance_7();
    if (!(63 === (63 & seen0))) {
      throwMissingFieldException(seen0, 63, $serializer_getInstance_5().o24_1);
    }
    var $this = createThis(this);
    $this.q24_1 = name;
    $this.r24_1 = code;
    ...
    if (0 === (seen0 & 64)) {
      ...
      $this.w24_1 = valuesListsIds;
    var tmp_0 = $this;
    tmp_0.x24_1 = lazy_0(CaosVariantData$_init_$lambda_7brc0u($this));
    var tmp_1 = $this;
    tmp_1.y24_1 = lazy_0(CaosVariantData$_init_$lambda_7brc0u_0($this));
    return $this;
  }
}
class Companion_8 {
  constructor() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.c25_1 = [tmp_1, tmp_3, lazy(tmp_4, Commands$Companion$$childSerializers$_anonymous__37qrhe_1)];
  }
}
class $serializer_6 {
  constructor() {
  ...
  e25(encoder, value) {
    ...
    var tmp1_output = encoder.bw(tmp0_desc);
    var tmp2_cached = Companion_getInstance_8().c25_1;
  ...
  mr(encoder, value) {
    return this.e25(encoder, value instanceof Commands ? value : THROW_CCE());
  }
  nr(decoder) {
    var tmp0_desc = this.d25_1;
    var tmp1_flag = true;
    ...
    var tmp8_cached = Companion_getInstance_8().c25_1;
    if (tmp7_input.sw()) {
    ...
    return Commands.f25(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, null);
  }
  lr() {
    return this.d25_1;
  }
  l14() {
    var tmp0_cached = Companion_getInstance_8().c25_1;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
...
class Commands {
  ...
  static f25(seen0, commands, rvalues, lvalues, serializationConstructorMarker) {
    Companion_getInstance_8();
    if (!(7 === (7 & seen0))) {
      throwMissingFieldException(seen0, 7, $serializer_getInstance_6().d25_1);
    }
    var $this = createThis(this);
    $this.commands = commands;
    $this.rvalues = rvalues;
...
class Companion_9 {
  constructor() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.n25_1 = [null, tmp_1, null, null, null, null, null, tmp_3, null, null, lazy(tmp_4, VariantCaosCommand$Companion$$childSerializers$_anonymous__495hkq_1), null, null, null, null, null, null];
  }
}
class $serializer_7 {
  constructor() {
  ...
  p25(encoder, value) {
    ...
    var tmp1_output = encoder.bw(tmp0_desc);
    var tmp2_cached = Companion_getInstance_9().n25_1;
  ...
  mr(encoder, value) {
    return this.p25(encoder, value instanceof ICaosCommand ? value : THROW_CCE());
  }
  nr(decoder) {
    var tmp0_desc = this.o25_1;
    var tmp1_flag = true;
    ...
    var tmp22_cached = Companion_getInstance_9().n25_1;
    if (tmp21_input.sw()) {
    ...
    return ICaosCommand.q25(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, tmp7_local3, tmp8_local4, tmp9_local5, tmp10_local6, tmp11_local7, tmp12_local8, tmp13_local9, tmp14_local10, tmp15_local11, tmp16_local12, tmp17_local13, tmp18_local14, tmp19_local15, tmp20_local16, null);
  }
  lr() {
    return this.o25_1;
  }
  l14() {
    var tmp0_cached = Companion_getInstance_9().n25_1;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
...
class ICaosCommand {
  ...
  f26(command, parameters, isLvalue, isRvalue, isCommand, returnTypeId, returnTypeName, variants, description, lvalueName, returnValuesListIds, requiresOwnr, commandGroup, doifFormat, requiresCreatureOwnr, tokens, ceOnly) {
  ...
  g26(command, parameters, isLvalue, isRvalue, isCommand, returnTypeId, returnTypeName, variants, description, lvalueName, returnValuesListIds, requiresOwnr, commandGroup, doifFormat, requiresCreatureOwnr, tokens, ceOnly, $super) {
    ...
    return $super === VOID ? this.f26(command, parameters, isLvalue, isRvalue, isCommand, returnTypeId, returnTypeName, variants, description, lvalueName, returnValuesListIds, requiresOwnr, commandGroup, doifFormat, requiresCreatureOwnr, tokens, ceOnly) : $super.f26.call(this, command, parameters, isLvalue, isRvalue, isCommand, returnTypeId, returnTypeName, variants, description, lvalueName, returnValuesListIds, requiresOwnr, commandGroup, doifFormat, requiresCreatureOwnr, tokens, ceOnly);
  }
  toString() {
  ...
  static q25(seen0, command, parameters, isLvalue, isRvalue, isCommand, returnTypeId, returnTypeName, variants, description, lvalueName, returnValuesListIds, requiresOwnr, commandGroup, doifFormat, requiresCreatureOwnr, tokens, ceOnly, serializationConstructorMarker) {
    Companion_getInstance_9();
    if (!(102895 === (102895 & seen0))) {
      throwMissingFieldException(seen0, 102895, $serializer_getInstance_7().o25_1);
    }
    var $this = createThis(this);
    $this.command = command;
    $this.parameters = parameters;
...
class $serializer_8 {
  ...
  mr(encoder, value) {
    return this.i26(encoder, value instanceof ICaosParameter ? value : THROW_CCE());
  }
  nr(decoder) {
    var tmp0_desc = this.h26_1;
    var tmp1_flag = true;
    ...
    tmp9_input.cw(tmp0_desc);
    return ICaosParameter.j26(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, tmp7_local3, tmp8_local4, null);
  }
  lr() {
    return this.h26_1;
  }
...
class ICaosParameter {
  static k26(index, name, typeId, typeName, valuesListId) {
  ...
  static m26(parameter, variant) {
    var tmp = parameter.d1s().simpleName;
    var tmp0_safe_receiver = parameter.valuesListIds;
    return this.k26(parameter.index, parameter.name, parameter.typeId, tmp, tmp0_safe_receiver == null ? null : tmp0_safe_receiver.r3(variant));
  }
  toString() {
  ...
  static j26(seen0, index, name, typeId, typeName, valuesListId, serializationConstructorMarker) {
    if (!(15 === (15 & seen0))) {
      throwMissingFieldException(seen0, 15, $serializer_getInstance_8().h26_1);
    }
    var $this = createThis(this);
    $this.index = index;
    $this.name = name;
...
class Companion_11 {
  ...
  o26(typeSerial0) {
    return $serializer_9.m25(typeSerial0);
  }
  y14(typeParamsSerializers) {
...
class $serializer_9 {
  ...
  q26(encoder, value) {
    ...
    if (tmp1_output.zx(tmp0_desc, 0) ? true : !(value.C1 == null)) {
      tmp1_output.vx(tmp0_desc, 0, this.l25_1, value.C1);
    }
    if (tmp1_output.zx(tmp0_desc, 1) ? true : !(value.C2 == null)) {
      tmp1_output.vx(tmp0_desc, 1, this.l25_1, value.C2);
    }
    if (tmp1_output.zx(tmp0_desc, 2) ? true : !(value.CV == null)) {
      tmp1_output.vx(tmp0_desc, 2, this.l25_1, value.CV);
    }
    if (tmp1_output.zx(tmp0_desc, 3) ? true : !(value.C3 == null)) {
      tmp1_output.vx(tmp0_desc, 3, this.l25_1, value.C3);
    }
    if (tmp1_output.zx(tmp0_desc, 4) ? true : !(value.DS == null)) {
      tmp1_output.vx(tmp0_desc, 4, this.l25_1, value.DS);
    }
    if (tmp1_output.zx(tmp0_desc, 5) ? true : !(value.SM == null)) {
      tmp1_output.vx(tmp0_desc, 5, this.l25_1, value.SM);
    }
    tmp1_output.cw(tmp0_desc);
  }
  mr(encoder, value) {
    return this.q26(encoder, value instanceof VariantData ? value : THROW_CCE());
  }
  nr(decoder) {
    var tmp0_desc = this.k25_1;
    var tmp1_flag = true;
    ...
    if (tmp10_input.sw()) {
      tmp4_local0 = tmp10_input.pw(tmp0_desc, 0, this.l25_1, tmp4_local0);
      tmp3_bitMask0 = tmp3_bitMask0 | 1;
      tmp5_local1 = tmp10_input.pw(tmp0_desc, 1, this.l25_1, tmp5_local1);
      tmp3_bitMask0 = tmp3_bitMask0 | 2;
      tmp6_local2 = tmp10_input.pw(tmp0_desc, 2, this.l25_1, tmp6_local2);
      tmp3_bitMask0 = tmp3_bitMask0 | 4;
      tmp7_local3 = tmp10_input.pw(tmp0_desc, 3, this.l25_1, tmp7_local3);
      tmp3_bitMask0 = tmp3_bitMask0 | 8;
      tmp8_local4 = tmp10_input.pw(tmp0_desc, 4, this.l25_1, tmp8_local4);
      tmp3_bitMask0 = tmp3_bitMask0 | 16;
      tmp9_local5 = tmp10_input.pw(tmp0_desc, 5, this.l25_1, tmp9_local5);
      tmp3_bitMask0 = tmp3_bitMask0 | 32;
    } else
      while (tmp1_flag) {
    ...
    return VariantData.r26(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, tmp7_local3, tmp8_local4, tmp9_local5, null);
  }
  lr() {
    return this.k25_1;
  }
  l14() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    return [get_nullable(this.l25_1), get_nullable(this.l25_1), get_nullable(this.l25_1), get_nullable(this.l25_1), get_nullable(this.l25_1), get_nullable(this.l25_1)];
  }
  m14() {
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
  ...
  static m25(typeSerial0) {
    var $this = this.p26();
    $this.l25_1 = typeSerial0;
    return $this;
  }
}
class VariantData {
  static s26(C1, C2, CV, C3, DS, SM) {
  ...
  static z26(map) {
    Companion_getInstance_11();
    return this.s26(map.r3('C1'), map.r3('C2'), map.r3('CV'), map.r3('C3'), map.r3('DS'), map.r3('SM'));
  }
  copyWithValueForVariantEnum(variant, value) {
    ...
    if (variant.equals(C1_getInstance())) {
      ...
      tmp = this.a27(VOID, value);
    } else if (variant.equals(CV_getInstance())) {
      tmp = this.a27(VOID, VOID, value);
    } else if (variant.equals(C3_getInstance())) {
      tmp = this.a27(VOID, VOID, VOID, value);
    } else if (variant.equals(DS_getInstance())) {
      tmp = this.a27(VOID, VOID, VOID, VOID, value);
    } else if (variant.equals(SM_getInstance())) {
      tmp = this.a27(VOID, VOID, VOID, VOID, VOID, value);
    } else {
  ...
  b27(C1, C2, CV, C3, DS, SM) {
    return VariantData.s26(C1, C2, CV, C3, DS, SM);
  }
  a27(C1, C2, CV, C3, DS, SM, $super) {
    ...
    return $super === VOID ? this.b27(C1, C2, CV, C3, DS, SM) : $super.b27.call(this, C1, C2, CV, C3, DS, SM);
  }
  toString() {
  ...
  static r26(seen0, C1, C2, CV, C3, DS, SM, serializationConstructorMarker) {
    Companion_getInstance_11();
    if (!(0 === (0 & seen0))) {
      throwMissingFieldException(seen0, 0, Companion_getInstance_11().n26_1);
    }
    var $this = createThis(this);
    if (0 === (seen0 & 1))
      $this.C1 = null;
...
function CaosCommand$tokens$delegate$lambda(this$0) {
  return () => {
    ...
    var this_0 = split(this$0.d21_1, charArrayOf([_Char___init__impl__6a9atx(32)]));
...
function CaosCommand$fullCommandHeader$delegate$lambda(this$0) {
  return () => {
    var commandHeader = formatNameWithType(this$0.d21_1, this$0.v21());
    var tmp;
    if (nullIfEmpty(this$0.e21_1) == null) {
      tmp = null;
    } else {
      // Inline function 'kotlin.let' call
      var builder = StringBuilder.we(commandHeader);
      var indexedObject = this$0.e21_1;
      var inductionVariable = 0;
      var last = indexedObject.length;
      while (inductionVariable < last) {
        var parameter = indexedObject[inductionVariable];
        inductionVariable = inductionVariable + 1 | 0;
        builder.t(' ').t(formatNameWithType(parameter.name, parameter.d1s()));
      }
...
function CaosCommand$isCommand$delegate$lambda(this$0) {
  return () => !(this$0.k21_1 || this$0.l21_1);
}
...
function CaosValuesListValue$greaterThan$delegate$lambda(this$0) {
  return () => !(this$0.n1s() == null) && startsWith(this$0.value, '>');
}
...
function CaosVariantData$isOld$delegate$lambda(this$0) {
  return () => listOf(['C1', 'C2']).g2(this$0.r24_1);
}
...
function VariantCaosCommand$Companion$$childSerializers$_anonymous__495hkq_1() {
  return $serializer_9.m25(IntSerializer_getInstance());
}
...
function toVariantCommand(_this__u8e3s4, variant) {
  var tmp1_command = _this__u8e3s4.d21_1;
  // Inline function 'kotlin.collections.map' call
  var this_0 = _this__u8e3s4.e21_1;
  // Inline function 'kotlin.collections.mapTo' call
  ...
  while (inductionVariable < last) {
    ...
    inductionVariable = inductionVariable + 1 | 0;
    var tmp$ret$2 = ICaosParameter.m26(item, variant);
    destination.z1(tmp$ret$2);
  }
  ...
  var tmp3_isLvalue = _this__u8e3s4.l21_1;
  var tmp4_isRvalue = _this__u8e3s4.k21_1;
  var tmp5_returnTypeId = _this__u8e3s4.v21().value;
  var tmp6_returnTypeName = _this__u8e3s4.v21().simpleName;
  var tmp7_variants = _this__u8e3s4.j21_1;
  var tmp8_description = _this__u8e3s4.g21_1;
  var tmp9_commandGroup = _this__u8e3s4.n21_1;
  var tmp10_doifFormat = _this__u8e3s4.o21_1;
  var tmp11_lvalueName = _this__u8e3s4.m21_1;
  var tmp12_requiresCreatureOwnr = _this__u8e3s4.p21_1;
  var tmp13_requiresOwnr = _this__u8e3s4.i21_1;
  ...
  if (tmp0_safe_receiver == null) {
    ...
    // Inline function 'kotlin.let' call
    tmp_0 = VariantData.z26(tmp0_safe_receiver);
  }
  var tmp14_returnValuesListIds = tmp_0;
  var tmp15_isCommand = _this__u8e3s4.x21();
  var tmp16_tokens = _this__u8e3s4.p1s();
  var tmp17_ceOnly = _this__u8e3s4.q21_1 === true;
...
initMetadataForClass(VariantData, 'VariantData', VariantData.s26, VOID, VOID, VOID, VOID, {0: Companion_getInstance_11});
