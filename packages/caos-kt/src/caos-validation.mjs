...
class ErrorFormatter {
  ...
  i5a(command, expected, actualType) {
...
class VariableValidator {
  constructor() {
    ...
    // Inline function 'kotlin.js.asDynamic' call
    var tmp$ret$0 = ['C1', 'C2'];
    tmp.l5a_1 = tmp_0.j5a('VARx', tmp_1.k5a(tmp$ret$0));
    var tmp_2 = this;
    ...
    tmp_2.m5a_1 = tmp_3.j5a('VAxx', tmp_4.k5a(tmp$ret$3));
    var tmp_5 = this;
    ...
    tmp_5.n5a_1 = tmp_6.j5a('OVxx', tmp_7.k5a(tmp$ret$6));
    this.o5a_1 = 'C1 supports only OBV0-OBV2 object variables';
    var tmp_8 = this;
    ...
    // Inline function 'kotlin.js.asDynamic' call
    var tmp$ret$9 = ['C1', 'C2'];
    tmp_8.p5a_1 = tmp_9.j5a('OBVx', tmp_10.k5a(tmp$ret$9));
    var tmp_11 = this;
    ...
    tmp_11.q5a_1 = tmp_12.j5a('MVxx', tmp_13.k5a(tmp$ret$12));
    var tmp_14 = this;
    tmp_14.r5a_1 = VariableValidator$C1$lambda;
    var tmp_15 = this;
    tmp_15.s5a_1 = VariableValidator$C2$lambda;
    var tmp_16 = this;
    tmp_16.t5a_1 = VariableValidator$C2e$lambda;
  }
}
class sam$kotlin_Comparator$0 {
  constructor(function_0) {
    this.u5a_1 = function_0;
  }
  wg(a, b) {
    return this.u5a_1(a, b);
  }
  compare(a, b) {
    return this.wg(a, b);
  }
...
class sam$kotlin_Comparator$0_0 {
  constructor(function_0) {
    this.v5a_1 = function_0;
  }
  wg(a, b) {
    return this.v5a_1(a, b);
  }
  compare(a, b) {
    return this.wg(a, b);
  }
...
function inspectMvto(variant, call, errors, suggestions) {
  ...
  var error = new ErrorVal(call.g4x_1, "Setting agent's position to agent's same self position", 9, call.o4x_1, VOID, TypeTokens_getInstance().WARNING);
...
function VariableValidator$C1$lambda(group, index) {
  ...
  switch (group) {
    case 'VARx':
      ...
      break;
    case 'VAxx':
      tmp = VariableValidator_getInstance().m5a_1;
      break;
    case 'OBVx':
      tmp = index < 3 ? null : 'C1 supports only OBV0-OBV2 object variables';
      break;
    case 'OVxx':
      tmp = VariableValidator_getInstance().n5a_1;
      break;
    case 'MVxx':
      tmp = VariableValidator_getInstance().q5a_1;
      break;
    default:
      tmp = null;
      break;
...
function VariableValidator$C2$lambda(group, _unused_var__etf5q3) {
  return group === 'MVxx' ? VariableValidator_getInstance().q5a_1 : null;
}
function VariableValidator$C2e$lambda(group, _unused_var__etf5q3) {
  switch (group) {
    case 'VARx':
      return VariableValidator_getInstance().l5a_1;
    case 'OBVx':
      return VariableValidator_getInstance().p5a_1;
    default:
      return null;
  }
}
...
function addCommandErrors(variant, isCaos2, ceEnabled, commandCalls, errors, suggestions, checkCancelled) {
  ...
  while (inductionVariable < last) {
    ...
    inductionVariable = inductionVariable + 1 | 0;
    collectTypeErrors(variant.w4r(), commandCall, errors, suggestions, checkCancelled);
    collectIncompleteCommandErrors(variant.w4r(), commandCall, errors, suggestions, checkCancelled);
    outOfVariantCommandErrors(variant.w4r(), commandCall, isCaos2, ceEnabled, errors, suggestions, checkCancelled);
...
function collectTypeErrors(variant, call, errors, suggestions, checkCancelled) {
  ...
  $l$loop_0: while (inductionVariable < last) {
    ...
    var argumentType = Companion_instance.fromIntValue(argument.g4q());
    ...
    var error = new ErrorVal(argument.d1e(), ErrorFormatter_instance.i5a(call.f4x_1, parameter, argumentType.simpleName), 1, argument.j1f());
    errors.z1(new Tuple(error, suggestion_0));
  }
}
function collectIncompleteCommandErrors(variant, call, errors, suggestions, checkCancelled) {
  ...
  var error = new ErrorVal(range, call.f4x_1 + ' is missing parameters [' + missingParameterString + '] (Index:' + range.g1e() + ', Line:' + range.h1().e1e() + ',Column:' + range.h1().i1e() + ')', 2, call.o4x_1);
  errors.z1(new Tuple(error, suggestion_0));
}
function outOfVariantCommandErrors(variant, call, isCaos2, ceEnabled, errors, suggestions, checkCancelled) {
  ...
  if (isCaos2 && get_caos2ScriptDelimiters().vf(call.f4x_1)) {
    return Unit_instance;
  }
  var tmp;
  // Inline function 'kotlin.text.uppercase' call
  // Inline function 'kotlin.js.asDynamic' call
  if (call.f4x_1.toUpperCase() === 'ELIF') {
  ...
  errors.z1(new Tuple(new ErrorVal(call.tokenTextRange, ErrorFormatter_instance.h5a(call.f4x_1, ErrorFormatter_instance.k5a(variants)), 3, call.o4x_1), suggestion_0));
}
function collectOutOfVariantParameterErrors(variant, call, errors, suggestions, checkCancelled) {
  ...
  $l$loop: while (inductionVariable < last) {
    var element = indexedObject[inductionVariable];
    inductionVariable = inductionVariable + 1 | 0;
    var tmp0_elvis_lhs = CommandLookupUtil_instance.parameterFromArgument(variant.w4r(), element);
    var tmp;
    if (tmp0_elvis_lhs == null) {
      continue $l$loop;
    } else {
    ...
    var parameter = tmp;
    var parameterType = Companion_instance.fromIntValue(parameter.typeId);
    var argumentType = Companion_instance.fromIntValue(element.g4q());
...
function addCEOnlyError(variant, ceEnabled, commandCall, command, errors, suggestions, checkCancelled) {
  ...
  errors.z1(new Tuple(new ErrorVal(commandCall.tokenTextRange, command.command + ' ' + Companion_instance.wrappedSimpleName(command.returnTypeId) + ' is Community Edition only.', 10, commandCall.o4x_1), suggestion_0));
  return true;
}
function annotateByteStringVariantError(variant, argument, parameterType, argumentType, errors, suggestions, checkCancelled) {
  ...
  var tmp_0;
  if (variant.x4r() && contains(textWithoutBrackets, ' ')) {
  ...
  } else if (variant.z4r() && endsWith(textWithoutBrackets, _Char___init__impl__6a9atx(82))) {
...
function addEqErrors(variant, items, errors, suggestions, checkCancelled) {
  ...
  var validRegex = tmp;
  var tmp_0;
  if (suggestions && variant.x4r()) {
    tmp_0 = addEqErrors$lambda;
  } else if (suggestions && variant.z4r()) {
    ...
    if (tmp0_elvis_lhs == null) {
      ...
      if (item instanceof CommandToken) {
        ...
        if (!(item.a1q_1.length === 4)) {
          ...
          var tmp1_safe_receiver = tmp_3.t4v(tmp$ret$0);
...
function addTokenFormatErrors(variant, commandCalls, errors, suggestions, checkCancelled) {
  if (variant.x4r()) {
    ...
    while (inductionVariable < last) {
      ...
      inductionVariable = inductionVariable + 1 | 0;
      checkCancelled();
      tokenArguments(variant.w4r(), element, tokens);
    }
...
function tokenArguments(variant, command, tokenItems) {
  ...
  $l$loop_1: while (inductionVariable < last) {
    ...
    if (argument instanceof CommandCall) {
      ...
      var tmp1_elvis_lhs = argument.a4w();
      var tmp_0;
      if (tmp1_elvis_lhs == null) {
        continue $l$loop_1;
      } else {
...
function addVarErrors(variant, items, errors, suggestions, checkCancelled) {
  ...
  var getError = variant.equals(C1_getInstance()) ? VariableValidator_getInstance().r5a_1 : variant.equals(C2_getInstance()) ? VariableValidator_getInstance().s5a_1 : VariableValidator_getInstance().t5a_1;
...
function addVariantStringErrors(variant, items, commandCalls, errors, suggestions, checkCancelled) {
      ...
      $l$block_4: {
        ...
        $l$block_1: {
          ...
          while (inductionVariable_1 < last_1) {
            ...
            inductionVariable_1 = inductionVariable_1 + 1 | 0;
            if (inRange(element_1.g4x_1, range.h1().e1e(), range.h1().i1e(), false, true)) {
              tmp$ret$6 = element_1;
              break $l$block_1;
            }
          }
        ...
        var command = tmp_1;
        var tmp1_safe_receiver = drillDownToParameter(variant.w4r(), command, range.h1().e1e(), range.h1().i1e() + 1 | 0);
  ...
  if (isOldVariant) {
    ...
    while (inductionVariable_2 < last_2) {
      ...
      // Inline function 'kotlin.text.lowercase' call
      // Inline function 'kotlin.js.asDynamic' call
      if (element_2.f4x_1.toLowerCase() === '{eq}') {
    ...
    while (_iterator__ex2g4s_0.x()) {
      ...
      while (inductionVariable_3 < last_3) {
        ...
        if (get_stringLikeTypesAsInt().g2(element_4.g4q())) {
...
function validateCaosParseResult(result, ceEnabled, checkCancelled) {
  ...
  var variant = orElse_0(tmp_0.a4s(tmp$ret$0), DS_getInstance());
...
function validateCaos(variant, caos, ceEnabled, checkCancelled) {
  ...
  var parseResult = tmp_0.p4w(variant, caos, validateCaos$lambda_0(checkCancelled));
...
function validateCaos_jsApi$lambda_0($checkCancelled) {
  return () => {
    ...
    try {
      ...
      var tmp_0;
      var _unused_var__etf5q3 = $p;
      throw ParseCancelledException.y1u();
    }
    return Unit_instance;
  };
}
