...
export class WorkspaceScopedArray<T> {
    ...
    private getNotUndefinedCreatingIfUndefined(workspaceUri: DocumentUri, init: T[] | (() => T[]) = []): T[] {
    ...
    private getOrUndefined(workspaceUri: DocumentUri): T[] | undefined {
        if (typeof this.values[workspaceUri] !== "undefined") {
            return this.values[workspaceUri];
        }
        return undefined;
    ...
    set(workspaceUri: DocumentUri, setter: Nullable<T[]> | ((value: T[]) => T[])): void {
        if (typeof setter === "function") {
            if (typeof this.values[workspaceUri] === "undefined") {
                this.values[workspaceUri] = (setter as Function)([]);
            } else {
    ...
    length(workspaceUri: DocumentUri): number {
     ...
     */
    push(workspaceUri: DocumentUri, ...items: T[]): number {
     ...
     */
    pop(workspaceUri: DocumentUri): T | undefined {
     ...
     * If the array is empty, undefined is returned and the array is not modified.
     */
    shift(workspaceUri: DocumentUri): T | undefined {
        return this.getOrUndefined(workspaceUri)
            ?.shift()
    }
     ...
     * If the array is empty, undefined is returned and the array is not modified.
     */
    remove(workspaceUri: DocumentUri, ...items: T[]) {
     ...
     */
    slice(workspaceUri: DocumentUri, start: number, end?: Nullable<number>): T[] {
        return this.getOrUndefined(workspaceUri)
            ?.slice(start, end ?? undefined) ?? [];
    }
    
    splice(workspaceUri: DocumentUri, start: number, end?: Nullable<number>): T[] {
        return this.getOrUndefined(workspaceUri)
     ...
     */
    concat(workspaceUri: DocumentUri, ...items: (T | ConcatArray<T>)[]): T[] {
     ...
     */
    join(workspaceUri: DocumentUri, separator?: string): string {
        return this.getOrUndefined(workspaceUri)
            ?.join(separator) ?? "";
    }
     ...
     */
    reverse(workspaceUri: DocumentUri): T[] {
        return this.getOrUndefined(workspaceUri)
            ?.reverse() ?? [];
    }
     ...
     * This method mutates the array and returns a reference to the same array.
     */
    reversed(workspaceUri: DocumentUri): T[] {
        const array = this.getOrUndefined(workspaceUri);
     ...
     * ```
     */
    sort(workspaceUri: DocumentUri, compareFn?: (a: T, b: T) => number): T[] {
        return this.getOrUndefined(workspaceUri)
            ?.sort(compareFn) ?? [];
    }
     ...
     * ```
     */
    sorted(workspaceUri: DocumentUri, compareFn?: (a: T, b: T) => number): T[] {
        const array = this.getOrUndefined(workspaceUri);
        const copy = array != undefined ? [...array] : [];
     ...
     */
    indexOf(workspaceUri: DocumentUri, searchElement: T, fromIndex?: number): number {
        return this.getOrUndefined(workspaceUri)
     ...
     */
    lastIndexOf(workspaceUri: DocumentUri, searchElement: T, fromIndex?: number): number {
        return this.getOrUndefined(workspaceUri)
     ...
     */
    every<S extends T>(workspaceUri: DocumentUri, predicate: (value: T, index: number, array: T[]) => value is S, thisArg?: any): this is S[] {
     ...
     * If thisArg is omitted, undefined is used as the "this" value.
     */
    some(workspaceUri: DocumentUri, predicate: (value: T, index: number, array: T[]) => unknown, thisArg?: any): boolean {
     ...
     */
    forEach(workspaceUri: DocumentUri, callbackfn: (value: T, index: number, array: T[]) => void, thisArg?: any): void {
        return this.getOrUndefined(workspaceUri)
