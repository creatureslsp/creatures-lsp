...
const ticks = new Map();
const docVersions = new LanguageDocumentData();
export function nextDocumentVersionId(languageId, documentURI) {
...
const newArray = () => [];
const mergeDiagnostics = async (language, documentURI, newVersion, diagnosticsInRange, range) => {
...
const expandedRange = (language, documentURI, range) => {
...
export async function validateDocument(documentOrUri, documentVersion, range) {
    try {
...
async function _validateDocument(documentOrUri, documentVersion, range) {
    let diagnostics;
